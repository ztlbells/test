...
- `invoke`   调用合约内部的函数
- `query`   查询相关的信息
- `createUser` 创建新用户，并加入到能源微网中
- `buyByAddress` 向某一位用户购买一定量的电力
- `getAddressesBuyNumber` 查询具有一定额的电力的用户的地址
- `getTransactionById` 通过id获取交易内容
- `getTransactions` 获取交易（如果交易数大于10，获取前10个）
...
```
{
  ...
  "params": {
    "type": 1,
    "chaincodeID":{
        "path":"https://github.com/swbsin/test/chaincode_example05/"
    },
    "ctorMsg": {
        "function":"init",
         "args":[""]
...
```
{
    ...
    "result": {
        "status": "OK",
        "message": "b76a79ba797ba59033de633e7350795b55153bd6a14b9e880a97d3995c6e1c629cfb78907120cec745f67797c7f92350cd8bebfe0f7945ddfa394483e1210ffd"
    },
    "id": 1
}
```
